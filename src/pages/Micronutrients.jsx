    ...
    <div id="micro" className="py-10">
      ...
      <div className="flex flex-col justify-center items-center mt-5 gap-y-5">
        ...
        <div className='w-[60%] grid gap-2 border-2 border-black py-3 px-4 rounded-lg bg-white sm:w-[80%] md:w-[60%]'>
            ...
            <p className='indent-10'>Ang <i>iron</i> ay isang mineral kung saan ito ay tumutulong sa paggawa ng <i>hemoglobin</i>. Ang <i>hemoglobin</i> ay isang uri ng protina na matatagpuan sa ating dugo kung saan ang layunin nito ay ikalat ang iba’t ibang sustansya at <i>oxygen</i> sa iba’t ibang parte ng katawan. Isa pa dito, kinakailangan din ang <i>iron</i> upang maiwasan ang komplikasyon tulad ng <i>anemia</i>.</p>
            </span>
            <span className='text-justify'>
            ...
            <p className='indent-10'>Ang <i>folic acid</i> naman ay isang bitamina kung saan ay nakatutulong sa isang ina sa pamamagitan ng paggawa ng bagong dugo. Isa pa dito, tumutulong din ito sa pagbuo at <i>develop</i> ng <i>nervous system</i> ng sanggol</p>
            </span>
          </div>
          ...
          <div className='w-[60%] grid gap-2 border-2 border-black py-3 px-4 rounded-lg bg-white sm:w-[80%] md:w-[60%]'>
            ...
            <p className='indent-10 text-justify'>
            Ang isang ina na nagbubuntis ay nangangailangang kumonsumo 31.7mg ng <i>iron</i> habang ang <i>folate (folic acid)</i> naman ay 530mcg. Bukod sa <i>supplements</i>, maaaring matagpuan ang dalawang <i>micronutrients</i> na ito sa mga pang-araw-araw na pagkain. 
            </p>
          </div>
          ...
          <div className='w-[60%] grid gap-2 border-2 border-black py-3 px-4 rounded-lg bg-white sm:w-[80%] md:w-[60%]'>
            ...
            Mga buntis sa unang trimester - 20 mg kada araw< br />
            Mga buntis sa ikalawang trimester - 24 mg kada araw< br />
            Mga buntis sa ikatlong trimester - 29 mg kada araw< br />
            </p>
          </div>
        ...
        <div className='w-[60%] grid gap-2 border-2 border-black py-3 px-4 rounded-lg bg-white sm:w-[80%] md:w-[60%]'>
            ...
            <p className='indent-10 text-justify'>
                Ang <i>micronutrients</i> ay madalas na makukuha sa mga gulay, prutas, at mga parte ng karne at manok. Makikita sa ibaba ang ilang halimbawa ng mga pagkain na mayaman sa <i>iron</i> at <i>folate</i>.
            </p>
        ...
        <div className='w-[60%] grid gap-2 border-2 border-black py-3 px-4 rounded-lg bg-white sm:w-[80%] md:w-[60%]'>
            ...
            <p className='indent-10 text-justify'>
                Ang <i>calcium</i> ay isang mineral kung saan ang layunin nito ay patibayin at palakasin ang buto ng isang tao. Ang tungkulin naman ng <i>calcium</i> sa pagbubuntis ay ang pagbuo ng ngipin at buto ng isang sanggol habang ito ay nasa sinapupunan. Dagdag pa dito nakakatulong din ito upang maiwasan ang pagkakaroon ng <i>preeclampsia</i> at <i>preterm birth</i> sa mga nagbubuntis. Matatagpuan ang <i>calcium</i> sa mga pagkain tulad ng gatas, yogurt, keso at tokwa. Ang inirerekomenda na dami ng pagkonsumo ng isang ina na nagbubuntis ay 800mcg para sa una at ikalawang trimester habang 850mcg naman sa ikatlo. 
            </p>
            ...
            <p className='indent-10 text-justify'>
                Ang <i>iodine</i> naman ay isang mineral kung saan nakakatulong ito upang paunlarin ang utak at <i>nervous system</i> ng isang sanggol. Tungkulin din ng <i>iodine</i> na payabungin ang kalusugan ng isang sanggol upang maiwasan ang pagkakaroon ng <i>fetal hypethyroidism</i>. Ayon sa mga eksperto, ang inirerekomenda na dami na pagkonsumo ng <i>iodine</i> ay 250mcg araw-araw.  
            </p>
            <h1 className='font-bold'>Bitamina A</h1>
            <p className='indent-10 text-justify'>
                Ang bitaminang A ay isang bitamina kung saan ang tungkulin nito ay makatulong sa pagbuo ng bawat <i>organ</i> ng sanggol at pati na rin palakasin ang <i>immune system</i> nito. Nakatutulong din ang bitamina A na panatilihing maayos ang paningin ng ina at ng kanyang sanggol. Ngunit, kailangan lamang ng isang inang nagbubuntis na kumonsumo ng sapat na dami ng bitaminang ito dahil maaaring magdulot ito ng mga hindi kaaya-ayang komplikasyon sa sanggol. Ang inirerekomendang dami ng pagkain ng bitaminang A ay 300mcg habang ipinagbabawal sa mga inang nagbubuntis na lumapagpas 3,000mcg dahil sa mga negatibong epekto nito.  
            </p>
