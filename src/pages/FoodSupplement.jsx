...
function FoodSupplement() {
  ...
  return (
    <div id="foodsupplement" className="py-10">
      ...
      <div className="flex flex-col justify-center items-center mt-5 gap-y-5">
        ...
        <div className='text-justify w-[60%] grid gap-2 border-2 border-black py-3 px-4 rounded-lg bg-white sm:w-[80%] md:w-[60%]'>
            ...
            <ol className='pl-5 list-decimal grid gap-y-4'>
                <li><span className='font-bold'>Ferrous Sulfate at Folic Acid</span> ay mga pangunahing bahagi ng mga prenatal vitamins upang maiwasan ang <i>anemia</i> at <i>neural tube defects</i> sa mga sanggol.</li>
                ...
                <li><span className='font-bold'>Multivitamins with Iron</span> ay <i>essential medicine</i> dahil nagbibigay ito ng kumpletong nutrisyon at maiwasan ang komplikasyon. </li>
        ...
        <div className='text-justify w-[60%] grid gap-2 border-2 border-black py-3 px-4 rounded-lg bg-white sm:w-[80%] md:w-[60%]'>
          ...
          <ul className='list-disc pl-5 text-justify grid gap-y-4'>
            ...
            <li>Mag-ingat sa mga <i>over-the-counter (OTC) products</i></li>
