        ...
        <div className="w-[60%] grid sm:w-full">
          ...
          <div className="text-justify font-quicksand">
            <p className="indent-10">
              ...
              Manila (FEU). Nais naming pasalamatan kayo sa pagtangkilik at paggamit ng website na ito upang paunlarin ang
            ...
            <div className="grid">
            <span className="indent-10 sm:indent-5 hover:font-bold text-blue-600">
                - Gmail: <a href="mailto:sagipwebpage2024@gmail.com">sagipwebpage2024@gmail.com</a>
            </span>
