    ...
    <div>
      <div className="py-1 z-10 bg-[#DE638A] sm:hidden md:hidden">
        <div className="flex justify-between items-center px-10">
          ...
          <div className='flex space-x-4'>
            <a href={`${pageId}`}>
            <button className="font-sans font-bold py-2 px-4 border border-[#DE638A] bg-pink-300 hover:bg-gray-300 text-xl rounded-3xl italic">
              About Us
            </button>
      ...
      >
        ...
        <div className="p-6">
          ...
          <a href={`${pageId}`}>
            <button className="block w-full font-sans font-bold py-2 px-4 mb-4 border border-[#DE638A] bg-pink-300 hover:bg-pink-500 text-xl rounded-3xl italic cursor-pointer">
              About Us
            </button>
          </a>
        </div>
